...
//ficheros de trazas
   ...
   sprintf(fichero, "%s%s/superviI_1.traza",HOME,DIRTRAZA);
   freopen(fichero, "w", stdout);
   sprintf(fichero, "%s%s/superviI_2.traza",HOME,DIRTRAZA);
...
int ya_bien(SVM *p3svm, char *proce, int mialarm)
{
 ...
 ii=0; 
 //PRJ0247167 - cambio una traza por otra para que no ocupe tanto sitio
