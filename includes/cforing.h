...
/***
   FICHERO: CFORING.H
   DESCRIPCION: Fichero con la estructura del formato mensaje para comunicacion con ING
...
{
    char          r05p_002[19]; /*SIO-1 tarjeta*/
...
//  char          r05p_respent[MAX_3];/*SIO-33 resp. entrada cominicaciones*/
...
{
    char          r09p_002[19]; /*SIO-1 tarjeta*/
    ...
    char          r09p_042[12];  /*Establecimiento/ Referencia TPV SIO-42*//** no se usa 30/05/2011 motivos historios, ademas el SIO-42 es de 16*/
    ...
    char          r09p_037[12];  /*SIO-40 num. operacion*/
    char          r09p_nouso[657];
    //char          r09p_nouso[711];
...
{
    char          r11p_002[19]; /* SIO-1 tarjeta*/
...
{
    char          r26p_002[19];   /*SIO-1 tarjeta*/  //nuevo campo decirselo oscar
    ...
    char          r26p_numfamily[2];
    char          r26p_038[6];        /*SIO-37 num autorización*/
    char          r26p_nouso[775];
...
{
    char          r60p_002[19];   /* SIO-1 tarjeta */
    ...
    char          r60p_047[55];   /* SIO-47 datos adic. fun. transp.,c.pin y c. idioma*/
...
typedef struct reg_51P
{
  char  r51p_041[10];  /* ATM: Identificador del terminal de cajero de 4B SIO-19*/
  char  r51p_atm[2];   /* LITERAL '4B' */
  char  r51p_011[6];   /* IDMESSAGE numero de operacion de cajero SIO-6 */
  char  r51p_012[12];  /* OPERDATE hora y fecha de la operacion SIO-7, SIO-10 */
  char  r51p_045[218]; /* TOTALINFO datos de totalizacion del cajero*/
  char  r51p_062[132]; /* STATUSINFO status del cajero */
}reg_51P;
...
typedef struct reg_08R //Respuesta general y de comunicaciones de autorización
{
    ...
    char          r08r_002[19];   /* SIO-1 tarjeta */
    char          r08r_003[6];
...
{
    char          r10r_002[19]; /* SIO-1 tarjeta */
    char          r10r_003[6];
...
{
    char          r12r_002[19]; /* SIO-1 tarjeta  */
...
{
    char          r27r_002[19]; /* SIO-1 tarjeta  */
...
{
    char          r61r_002[19];  /* SIO-1 tarjeta */
...
typedef struct reg_52R
{
  char     r52r_011[6];   /* numero de transación SIO-11*/
  char     r52r_039[3];   /* respuesta al mensaje */
...
typedef struct reg_com
{
    ...
    //char     rcom_regcue[MAX_452];    /* Registro cuentas */
    //char     rcom_regcom[MAX_38];    /* Registro comisiones */
    char     rcom_nouso[442];
} reg_com;
/*************************************/
...
typedef union formato_ing
{
  peticion_ing    vpeticion;
  respuesta_ing   vrespuesta;
